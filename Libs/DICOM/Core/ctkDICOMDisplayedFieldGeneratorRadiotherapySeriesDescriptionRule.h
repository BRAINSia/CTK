...
public:
  ...
  void registerEmptyFieldNames(QMultiMap<QString, QString> emptyFieldsSeries, QMultiMap<QString, QString> emptyFieldsStudies, QMultiMap<QString,
                               QString> emptyFieldsPatients) override;
