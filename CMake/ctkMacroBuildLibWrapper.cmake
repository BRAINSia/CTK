  ...
  if(HAS_DECORATOR)
    ...
    if(NOT CMAKE_AUTOMOC)
            message(FATAL_ERROR "qt5_wrap_cpp is deprecated in CMakified Qt5\n"
                    "versions and removed in Qt6. CMAKE_AUTOMOD must be turned ON.\n"
                    "and ${DECORATOR_HEADER} must be added to the sources."
            )
    endif()
  endif()
  include_directories(${CMAKE_CURRENT_BINARY_DIR}/CTKWidgets_autogen/include)
  add_library(${lib_name}PythonQt ${MY_WRAPPER_LIBRARY_TYPE} ${KIT_PYTHONQT_SRCS})
  target_link_libraries(${lib_name}PythonQt PUBLIC PythonQt::PythonQt ${lib_name} ${my_EXTRA_Python3_LIBRARIES})
